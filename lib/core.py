...
class SysTracError(Exception):
    """Exception base class for errors in SysTrac."""
...
class ComponentMeta(type):
    ...
    def __new__(cls, name, bases, d):
        ...
        #print "Metaclass calling __new__ for %s" % name
...
class Component(object):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        """
        #print "Component.__new__ called for %s, %s, %s" % (cls, args, kwargs)
